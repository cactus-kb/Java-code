    ...
    public void run() {
        try {
            ...
            if (request.psth.equals("/hello")) {
                ...
                os.flush();
            } else if (request.psth.equals("/run")) {
                ...
                os.write(responseSB.toString().getBytes("UTF-8"));
                os.flush();
            } else if (request.psth.equals("/joke.js")) {
                ...
                os.write(responseSB.toString().getBytes("UTF-8"));
                os.flush();
            } else if (request.psth.equals("/move")) {
                StringBuilder responseSB = new StringBuilder();
                ...
                os.write(responseSB.toString().getBytes("UTF-8"));
                os.flush();
            } else if (request.psth.equals("/set-cookie")) {
                StringBuilder responseSB = new StringBuilder();
                responseSB.append("HTTP/1.0 200 OK\r\n");
                ...
                os.write(responseSB.toString().getBytes("UTF-8"));
                os.flush();
            } else if (request.psth.contains("/login")) {
                // 获取当前登陆的用户名
                String[] group = request.psth.split("=");
                if (group.length != 2) {
                    StringBuilder responseSB = new StringBuilder();
                    ...
                    String username = request.psth.split("=")[1];
                    // 判断是否是登陆用户
            ...
            } else if (request.psth.equals("/profile")) {
